        ...
        <div className="flex gap-3">
          {documents.length > 0 && (
            <button
              ...
              className="bg-blue-600/20 text-blue-400 border border-blue-500/30 hover:bg-blue-600/30 px-4 py-2 rounded-md font-medium transition transform hover:-translate-y-0.5 flex items-center gap-2"
            >
